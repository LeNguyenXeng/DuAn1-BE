                        ...
                        <div class="bor12 p-t-15 p-b-30">
                            ...
                            <div class=" p-r-18 p-r-0-sm w-full-ssm">
                                <div class="p-t-15">
                                    ...
                                    <div class="formcheck" style="margin-left: 20px;">
                                        <div class="cl2"
                                            style="font-family: Poppins, sans-serif; text-transform: capitalize;">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault"
                                                id="flexRadioDefault1">
                                            <label for="flexRadioDefault1" style="font-size: 13px;">
                                        ...
                                        <div class="cl2"
                                            ...
                                            <label for="flexRadioDefault2" style="font-size: 13px;">
